    ...
    _signInWithGoogle().then((user) async {
      ...
      if (user != null) {
        ...
        if ((await APIs.userExists())) {
          await AuthService().login(user.user?.email);
          Navigator.pushReplacement(
              context, MaterialPageRoute(builder: (_) => const HomeScreenWithBottomBar()));
        } else {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Welcome to Badminton Buddy'),
      ),
      ...
      body: Stack(children: [
        ...
        Positioned(
            ...
            child: ElevatedButton.icon(
                ...
                //google icon
                icon: Icon(Icons.no_encryption_gmailerrorred_outlined), // Replace with your desired icon
