...
class _BookingCourtScreenState extends State<BookingCourtScreen> {
  ...
  Future<void> handleFindCourtsButtonClick() async {
    ...
    try {
      ...
      final url =
          'http://192.168.0.6/BadmintonBuddyServerSide/get_available_courts.php?facility_id=$facilityId&date=$selectedDate&time=$selectedTime&ampm=$selectedAMPM&duration=$selectedDuration';
