...
import 'booking_court_screen.dart';



class LoginScreenBook extends StatefulWidget {
  final Map<String, dynamic> facility;

  const LoginScreenBook({Key? key, required this.facility})
      : super(key: key);
  @override
  _LoginScreenBookState createState() => _LoginScreenBookState();
}
...
class _LoginScreenBookState extends State<LoginScreenBook> {
  ...
  Future<void> login() async {
    ...
    final stageLogin = 3;
    final currentData = widget.facility;
